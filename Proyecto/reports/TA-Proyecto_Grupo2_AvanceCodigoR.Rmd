...
## E. Ubicaciones (Top Provincias)

<div class="viz-container">

<div class="viz-image">
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("../figures/ubicaciones.png")
```
</div>
...
## Regiones Críticas
Identificamos las provincias dónde más se reportan excesos.

**¿Qué observamos?**
Vemos geográficamente dónde está el problema. Usualmente, provincias con grandes autopistas (como Guayas o Pichincha) encabezan la lista debido al mayor flujo vehicular.
...
<div class="viz-image">
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("../figures/tipo_transporte.png")
```
</div>
...
Analizamos quiénes cometen las infracciones.

**¿Qué observamos?**
Podemos ver si el problema es generalizado o específico de ciertas cooperativas (Taxis, Buses Interprovinciales, Carga). Esto ayuda a dirigir las capacitaciones.
